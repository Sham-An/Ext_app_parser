...
# Form implementation generated from reading ui file 'I:\pythonProjects\Ext_app_parser\app_View_task_GPT_WINVER.ui'
#
...
class Ui_TaskEDIT(object):
    def setupUi(self, TaskEDIT):
        ...
        self.GetHeadFromTask = QtWidgets.QPushButton(self.view)
        self.GetHeadFromTask.setObjectName("GetHeadFromTask")
        self.gridLayout_3.addWidget(self.GetHeadFromTask, 1, 0, 1, 1)
        ...
        self.GetHeadFromTask.clicked.connect(self.Task_view_text.paste) # type: ignore
        QtCore.QMetaObject.connectSlotsByName(TaskEDIT)
        TaskEDIT.setTabOrder(self.Get_Task, self.lineEdit)
        TaskEDIT.setTabOrder(self.lineEdit, self.tabWidget)
        TaskEDIT.setTabOrder(self.tabWidget, self.Path_scheme)
        TaskEDIT.setTabOrder(self.Path_scheme, self.Path_host)
        TaskEDIT.setTabOrder(self.Path_host, self.Path_parts)
        TaskEDIT.setTabOrder(self.Path_parts, self.Path_local)
        TaskEDIT.setTabOrder(self.Path_local, self.Path_cat1)
        TaskEDIT.setTabOrder(self.Path_cat1, self.Path_cat2)
        TaskEDIT.setTabOrder(self.Path_cat2, self.list_Query)
        TaskEDIT.setTabOrder(self.list_Query, self.View_Task)
        TaskEDIT.setTabOrder(self.View_Task, self.Task_view_text)
        TaskEDIT.setTabOrder(self.Task_view_text, self.GetHeadFromTask)
        TaskEDIT.setTabOrder(self.GetHeadFromTask, self.Copy)
    ...
    def retranslateUi(self, TaskEDIT):
        ...
        self.GetHeadFromTask.setText(_translate("TaskEDIT", "get from task"))
